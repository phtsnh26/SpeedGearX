...
class UpdateProfileClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "bang_lai_xe"      => "required|digits:12", // Thêm quy tắc cho bằng lái xe
        ];
    }
    ...
    {
        return [
            "cccd.*" => "Căn cước công dân không được để trống và phải là 12 số",
            "gioi_tinh.*"               => "Giới tính không được để trống và phải là Nam hoặc Nữ hoặc Khác",
            "bang_lai_xe.*"      => "Bằng lái xe không được để trống và phải là 12 số",
        ];
    }
}
