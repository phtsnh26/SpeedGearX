                    ...
                    <div class="product__details--media">
                            ...
                            <div class="swiper-wrapper" id="swiper-wrapper-7eedb9f2b2172155" aria-live="polite"
                                ...
                                <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" role="group"
                                    ...
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox"
                                            data-gallery="product-media-preview"
                                            href="/partsix/assets/img/product/big-product/product6.webp"><img
                                                class="product__media--preview__items--img"
                        ...
                        <div
                            ...
                            <div class="swiper-wrapper" id="swiper-wrapper-721fc2e6ec2a7d72" aria-live="polite"
                                ...
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-thumb-active"
                                    data-swiper-slide-index="0" role="group" aria-label="1 / 5"
                                ...
                                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="1"
                                    role="group" aria-label="2 / 5" style="width: 96px; margin-right: 20px;">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"
                                ...
                                <div class="swiper-slide swiper-slide-thumb-active" data-swiper-slide-index="0"
                                ...
                                <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="2" role="group"
                                    aria-label="3 / 5" style="width: 96px; margin-right: 20px;">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"
                                            src="/partsix/assets/img/product/small-product/product3.webp"
                                            alt="product-nav-img">
                                ...
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-thumb-active swiper-slide-visible"
                                    data-swiper-slide-index="0" role="group" aria-label="1 / 5"
                                    style="width: 96px; margin-right: 20px;">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"
                                ...
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-visible"
                                ...
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-visible swiper-slide-duplicate-prev"
                                    data-swiper-slide-index="2" role="group" aria-label="3 / 5"
                                    style="width: 96px; margin-right: 20px;">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"
                            ...
                            <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button"
                                aria-label="Next slide" aria-controls="swiper-wrapper-721fc2e6ec2a7d72">
                            ...
                            <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button"
                                aria-label="Previous slide" aria-controls="swiper-wrapper-721fc2e6ec2a7d72">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <form action="#">
                            ...
                            <div class="product__variant">
                                <div class="product__variant--list mb-10">
                                    <fieldset class="variant__input--fieldset">
                                        <legend class="product__variant--title mb-8">Số Chỗ: 4</legend>
                                    </fieldset>
                                </div>
                            ...
                            <div class="guarantee__safe--checkout">
                                ...
                                <img class="guarantee__safe--checkout__img"
                                    src="/partsix/assets/img/other/safe-checkout.webp" alt="Payment Image">
                            </div>
                        </form>
                    </div>
                </div>
