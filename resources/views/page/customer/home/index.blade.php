                                        ...
                                        <article class="product__card" style="height: 372px;">
                                            <div class="product__card--thumbnail">
                                                ...
                                                <ul
                                                    ...
                                                    <li v-if='v.isWishlists == 0'
                                                        class="product__card--action__list active">
                                                        <a class="product__card--action__btn yeuThich"
                                                    ...
                                                    <li v-else class="product__card--action__list">
                                                        <a id="yeuThich_30" :class="{ 'favorite': v.isFavorite }"
                                                            @mouseover="mouseoverWishlist(v)" @click="toggleWishlist(v)"
                                                            style="background: var(--secondary-color); color: var(--text-white-color);"
                                                            class="product__card--action__btn yeuThich" data-id="30"
                                                            title="Wishlist">
                                                            <svg class="product__card--action__btn--svg" width="18"
                                                                height="18" viewBox="0 0 16 13" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                ...
                toggleWishlist(vehicle) {
                    ...
                    axios.post('{{ Route('createWishlist') }}', payload)
                        .then((res) => {
                            ...
                            var id = '#yeuThich_' + vehicle.id;
                            if (res.data.trang_thai) {
                                $(id).addClass('favorite').css('background-color', 'red');
                            } else {
                                $(id).removeClass('favorite').css('background-color', 'white');
                            }
                            if (res.data.trang_thai === 1) {} else {}
                            this.getData();
                            loadDataWishlist();
                        })
                        .catch((res) => {
