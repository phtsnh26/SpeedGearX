        ...
        <div class="newsletter__area">
            <div class="newsletter__inner d-flex justify-content-between align-items-center">
                <div class="newsletter__content">
                    ...
                    <p class="newsletter__desc">Don’t wait make a smart &amp; logical quote here. Its pretty easy.
                    </p>
                </div>
            ...
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <div class="footer__logo">
                    <a class="footer__logo--link" href="index.html"><img
                            src="/partsix/assets/img/logo/nav-log-light.webp" alt="logo-img"></a>
                </div>
                ...
                <div class="footer__payment">
                    <img src="/partsix/assets/img/icon/payment-img.webp" alt="payment-img">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col">
                    <div class="quickview__gallery">
                        <div
                            ...
                            <div class="swiper-wrapper" id="swiper-wrapper-a101ffd0c7bce64910"
                                aria-live="polite"
                        ...
                        <div
                            ...
                            <div class="swiper-wrapper" id="swiper-wrapper-b1c94063a778ac1f"
                                aria-live="polite"
                                style="transform: translate3d(-402px, 0px, 0px); transition-duration: 0ms;">
                            ...
                            <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button"
                                aria-label="Next slide" aria-controls="swiper-wrapper-b1c94063a778ac1f">
                            ...
                            <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button"
                                aria-label="Previous slide" aria-controls="swiper-wrapper-b1c94063a778ac1f">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    class=" -chevron-left">
                                    ...
                                    <fieldset class="variant__input--fieldset">
                                        ...
                                        <div class="variant__color d-flex">
                                            <div class="variant__color--list">
                                                <input id="color-red1" name="color" type="radio"
                                                    checked="">
...
<button id="scroll__top"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
            stroke-width="48" d="M112 244l144-144 144 144M256 120v292"></path>
    </svg></button>
