        ...
        <div class="container">
            <div class="row ">
                <div class="col-6 d-flex  align-items-center">
                    <img src="/partsix/assets/img/logo/logo.png" alt="">
                </div>
                <div class="col-3">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title">Về Chúng Tôi <button class="footer__widget--button"
                        ...
                        <div class="footer__widget--inner">
                            <p class="footer__widget--desc">
                                Website thuê xe uy tín hàng đầu Việt Nam
                            </p>
    ...
    <div class="footer__bottom">
        <div class="container">
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <p class="copyright__content"><span class="text__secondary">© 2023</span>. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</footer>
